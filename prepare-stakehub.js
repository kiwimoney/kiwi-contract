...
program.option("-t, --template <template>", "StakeHubImpl template", "./contracts/StakeHubImpl.template");
program.option("-o, --output <output-file>", "StakeHubImpl.sol", "./contracts/StakeHubImpl.sol")
...
console.log("Succeed to generate StakeHubImpl.sol");
